...
} from "@/components/ai-chat/expandable-chat"
import { ChatMessageList } from "@/components/ai-chat/message-list"

export function ExpandableAiChat() {
      ...
      >
        ...
        <ExpandableChatFooter>
          <form
            ...
            className="relative p-1 rounded-lg border bg-background focus-within:ring-1 focus-within:ring-ring"
          >
            <ChatInput
              value={input}
              onChange={(e) => setInput(e.target.value)}
              placeholder="Type your message..."
              className="p-3 rounded-lg border-0 shadow-none resize-none min-h-12 bg-background focus-visible:ring-0"
            />
