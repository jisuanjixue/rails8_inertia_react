...
const ExpandableChatBody: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  className,
  ...props
}) => <div className={cn("overflow-y-auto flex-grow", className)} {...props} />;
...
const ExpandableChatToggle: React.FC<ExpandableChatToggleProps> = ({
  ...
  <Button
    ...
    onClick={toggleChat}
    className={cn(
      "flex justify-center items-center w-14 h-14 rounded-full shadow-md transition-all duration-300 hover:shadow-lg hover:shadow-black/30",
      className,
    )}
    {...props}
  >
